...
public class MonoSingleton<T> : MonoBehaviour where T : MonoBehaviour
{
    ...
    {
        Type _type = typeof(T);
        Debug.LogFormat("MonoBehaviour Singleton <{0}> awake init", _type.Name);
        Debug.LogFormat("Time.renderedFrameCount: {0} , Time.frameCount: {1}", Time.renderedFrameCount, Time.frameCount);
    }
